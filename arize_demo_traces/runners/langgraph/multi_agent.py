...
def run_multi_agent(
    ...
    **kwargs,
    ...
    with tracer.start_as_current_span("multi_agent_orchestration", attributes=attrs) as span:
        ...
        span.set_attribute("context.research_summary", (result.get("research_output") or "")[:2000])
        span.set_attribute("context.analysis_summary", (result.get("analysis_output") or "")[:2000])
        span.set_attribute("context.draft", (result.get("draft") or "")[:2000])
