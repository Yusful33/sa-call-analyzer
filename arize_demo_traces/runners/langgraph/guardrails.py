"""
LangGraph guardrails-only pipeline.
...
from ...use_cases.guardrails import QUERIES, GUARDRAILS, LOCAL_GUARDRAILS, sample_query
...
def run_guardrails(
    ...
    **kwargs,
    ...
    tracer = provider.get_tracer("demo.guardrails.langgraph")
